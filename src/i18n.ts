...
export function translate(language: Language, key: TranslationKey, ...args: string[]): string {
  const value = (translations[language] as Record<string, unknown>)[key] ?? key
