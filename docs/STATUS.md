...
- Reconnect attempts/backoff are bounded and guarded single-flight in the native command; stale transport generations are dropped before event replay, while a process-owned always-on supervisor remains future work.
